...
export DASHBOARD_STARTUP_SOURCES="${DASHBOARD_STARTUP_SOURCES:-jobvite_pragmaticplay,smartrecruitment,igamingrecruitment,jobrapido_uae,jobleads,gamblingcareers_remote,himalayas_igaming,linkedin_public,linkedin_georgia,linkedin_malta,indeed_uae,indeed_georgia,indeed_browserless_uae}"
