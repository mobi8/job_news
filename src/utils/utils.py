...
def save_scrape_state(
    ...
    all_job_sources = [
        ...
        "indeed_uae", "indeed_browserless_uae", "indeed_georgia", "indeed_malta",
        "linkedin_public", "linkedin_georgia", "linkedin_malta", "linkedin_jobspy",
        "glassdoor_uae",
        "gamblingcareers_remote",
        "himalayas_igaming",
...
def parse_requested_sources(raw_value: Optional[str]) -> Optional[set[str]]:
    ...
    alias_map = {
        ...
        "indeed_browserless": "indeed_browserless_uae",
        "indeed_browserless_uae": "indeed_browserless_uae",
        "browserless_indeed": "indeed_browserless_uae",
        "browserless_indeed_uae": "indeed_browserless_uae",
        ...
        "gamblingcareers": "gamblingcareers_remote",
        "gambling_careers": "gamblingcareers_remote",
        "gamblingcareers_remote": "gamblingcareers_remote",
        "himalayas": "himalayas_igaming",
        "himalayas_igaming": "himalayas_igaming",
        "google": "google_uae",
